 ...
 *
 * Note that by Bitcoin convention, SHA-256 hash strings are serialized in
...
class Sha256Hash final {
 ...
 public:
  ...
  // Constructs a Sha256Hash from the given array of 32 bytes (len is a dummy
  // parameter that must equal 32). Constant-time with respect to the given
  // array of values.
 public:
 ...
 public:
   ...
   **/
 public:
  std::string ToStringForProtocol();
};
