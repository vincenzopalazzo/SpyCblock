...
TEST(RunTest, read_two_block_consecutive_another_file_blk)
{
    //Init Log this test
    FLAGS_logtostderr = false;
    FLAGS_minloglevel = 0;
    google::SetLogDestination(google::GLOG_INFO, "/home/vincenzo/Github/SpyCblock/test/log/read_two_block_consecutive_another_file_blk.log");
