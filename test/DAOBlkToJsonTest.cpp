...
TEST(DAOBlkToJsonTest, test_dao_blk_to_json_blockchain_give_file_data) {
    ...
    google::SetLogDestination(google::GLOG_WARNING, "/home/vincenzo/Github/SpyCblock/test/log/test_dao_blk_to_json_blockchain_give_file_data.log");
...
TEST(DAOBlkToJsonTest, test_dao_blk_to_json_blockchain_give_file_data_error_one) {
    ...
    FLAGS_minloglevel = 1;
    FLAGS_logtostderr = false;
    google::SetLogDestination(google::GLOG_WARNING, "/home/vincenzo/Github/SpyCblock/test/log/test_dao_blk_to_json_blockchain_give_file_data_error_one.log");
...
TEST(DAOBlkToJsonTest, test_dao_blk_to_json_blockchain_give_file_data_error_two) {
    ...
    FLAGS_minloglevel = 1;
    FLAGS_logtostderr = false;
    google::SetLogDestination(google::GLOG_WARNING, "/home/vincenzo/Github/SpyCblock/test/log/test_dao_blk_to_json_blockchain_give_file_data_error_two.log");
...
TEST(DAOBlkToJsonTest, test_dao_blk_to_json_blockchain_give_file_data_error_null) {
    ...
    FLAGS_minloglevel = 1;
    FLAGS_logtostderr = false;
    google::SetLogDestination(google::GLOG_WARNING, "/home/vincenzo/Github/SpyCblock/test/log/test_dao_blk_to_json_blockchain_give_file_data_error_null.log");
